...
round(quantile(meantree3$n_landscape, .9)) # 404
# 690000 per 800 x 300

# generating point cloud  
x <- round(runif(round(quantile(meantree3$n_landscape, .9)), 0, 800))
y <- round(runif(round(quantile(meantree3$n_landscape, .9)), 0, 300))
...
# )
# 
# write.csv(trees_WFDS, here("data/output/tree_WFDS_3x_max.csv"), row.names = FALSE)
